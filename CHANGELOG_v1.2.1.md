...
- **Persistencia de estado**: El GUI recuerda y restaura el preset visualmente seleccionado al iniciar la aplicación.
...
- Eliminado un fallo que duplicaba el argumento `--keep-active`, causando errores de ejecución en scrcpy.
