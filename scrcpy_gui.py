...
PRESETS = {
    "video": {
        ...
        "badge": "4K/HQ",
        "codec": "h265", "max_size": 3840, "fps": 60, "bitrate": 32,
    ...
    "gaming": {
        ...
        "badge": "eSports",
        "codec": "h265", "max_size": 1920, "fps": 120, "bitrate": 16,
    ...
    "balanced": {
        ...
        "badge": "Estándar",
        "codec": "h265", "max_size": 1440, "fps": 60, "bitrate": 12,
        "audio": True, "audio_buffer": 60, "video_buffer": 5,
        "fullscreen": False, "stay_awake": True, "screen_off": False,
        "keyboard": "", "mouse": "", "gamepad": False,
        "record": False, "record_file": "", "print_fps": False,
        "show_touches": False, "crop": "",
    ...
    "ultra": {
        "label": "🚀  Vanguardia (AV1)", "desc": "Next-Gen: AV1 + High Refresh",
        "badge": "Beta/AV1",
