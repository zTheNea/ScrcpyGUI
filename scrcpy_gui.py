...
PRESETS = {
    "video": {
        "label": "🎬  Cinema", "desc": "Máxima fidelidad visual (4K/HEVC)",
        "badge": "Fidelidad",
    ...
    "gaming": {
        "label": "🎮  Pro Gaming", "desc": "Latencia mínima + Input HID",
        "badge": "eSports",
        "codec": "h264", "max_size": 1024, "fps": 120, "bitrate": 12,
        "audio": False, "audio_buffer": 0, "video_buffer": 0,
    ...
    "balanced": {
        "label": "⚖️  Equilibrado", "desc": "Estable para apps y navegación",
        "badge": "Estándar",
        "codec": "h265", "max_size": 1440, "fps": 60, "bitrate": 10,
        "audio": True, "audio_buffer": 40, "video_buffer": 10,
        "fullscreen": False, "stay_awake": True, "screen_off": False,
        "keyboard": "", "mouse": "", "gamepad": False,
        "record": False, "record_file": "", "print_fps": False,
        "show_touches": False, "crop": "",
    ...
    "ultra": {
        "label": "🚀  Ultra (AV1)", "desc": "Next-Gen: AV1 + High Refresh",
        "badge": "Vanguardia",
        "codec": "av1", "max_size": 0, "fps": 144, "bitrate": 32,
        "audio": True, "audio_buffer": 20, "video_buffer": 5,
        "fullscreen": True, "stay_awake": True, "screen_off": True,
        "keyboard": "uhid", "mouse": "uhid", "gamepad": True,
        "record": False, "record_file": "", "print_fps": True,
        "show_touches": False, "crop": "",
